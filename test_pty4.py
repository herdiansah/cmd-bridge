...
# Spawn command with prompt as argument
cmdline = f'cmd /c "set COMMAND_CODE_API_KEY={os.environ["COMMAND_CODE_API_KEY"]} && {cmd_bin} --model deepseek/deepseek-v4-pro --trust --skip-onboarding --max-turns 1 -p \\"{prompt}\\""'
